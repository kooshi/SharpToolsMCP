...
public static partial class AnalysisTools {
    ...
    public static async Task<object> GetAllSubtypes(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(GetAllSubtypes), cancellationToken);
    ...
    public static async Task<object> GetMembers(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(GetMembers), cancellationToken);
    ...
    public static async Task<string> ViewDefinition(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(ViewDefinition), cancellationToken);
    ...
    public static async Task<object> ListImplementations(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ErrorHandlingHelpers.ValidateStringParameter(fullyQualifiedSymbolName, "fullyQualifiedSymbolName", logger);
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(ListImplementations), cancellationToken);
    ...
    public static async Task<object> FindReferences(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ErrorHandlingHelpers.ValidateStringParameter(fullyQualifiedSymbolName, "fullyQualifiedSymbolName", logger);
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(FindReferences), cancellationToken);
    ...
    public static async Task<object> ViewInheritanceChain(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(ViewInheritanceChain), cancellationToken);
    ...
    public static async Task<object> ViewCallGraph(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(ViewCallGraph), cancellationToken);
    ...
    public static async Task<object> SearchDefinitions(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(SearchDefinitions), cancellationToken);
    ...
    public static async Task<object> ManageUsings(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(ManageUsings), cancellationToken);
    ...
    public static async Task<object> ManageAttributes(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(ManageAttributes), cancellationToken);
    ...
    public static async Task<string> AnalyzeComplexity(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            // Ensure solution is loaded
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(AnalyzeComplexity), cancellationToken);
    ...
    public static async Task<string> FindPotentialDuplicates(
        ...
        CancellationToken cancellationToken) {
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(FindPotentialDuplicates), cancellationToken);

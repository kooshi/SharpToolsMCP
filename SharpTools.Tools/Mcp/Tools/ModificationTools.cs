...
public static class ModificationTools {
    ...
    public static async Task<string> AddMember(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(AddMember), cancellationToken);
    ...
    public static async Task<string> OverwriteMember(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(OverwriteMember), cancellationToken);
    ...
    public static async Task<string> RenameSymbol(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            // Ensure solution is loaded
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(RenameSymbol), cancellationToken);
    ...
    public static async Task<string> ReplaceAllReferences(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            // Ensure solution is loaded
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(ReplaceAllReferences), cancellationToken);
    ...
    public static async Task<string> Undo(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(Undo), cancellationToken);
    ...
    public static async Task<string> FindAndReplace(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            // Ensure solution is loaded
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(FindAndReplace), cancellationToken);
    ...
    public static async Task<string> MoveMember(
        ...
        return await ErrorHandlingHelpers.ExecuteWithErrorHandlingAsync(async () => {
            ...
            await ToolHelpers.EnsureSolutionLoadedWithDetailsAsync(solutionManager, logger, nameof(MoveMember), cancellationToken);
